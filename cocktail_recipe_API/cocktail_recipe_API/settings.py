"""
Django settings for cocktail_recipe_API project.
...
ROOT_URLCONF = 'cocktail_recipe_API.urls'
...
WSGI_APPLICATION = 'cocktail_recipe_API.wsgi.application'
